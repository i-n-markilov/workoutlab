...
- **Asynchronous Tasks**: Background task processing for email notifications and user onboarding, powered by `django-background-tasks`.
...
2. **Background Worker**: `python manage.py process_tasks`
