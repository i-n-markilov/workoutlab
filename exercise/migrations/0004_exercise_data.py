...
EXERCISES = [
    ...
    ("Chest Press Machine",
     ...
     "Chest", None, False, ["Chest Press Machine"]),
    ...
    ("Cable Chest Fly",
     ...
     "Chest", None, False, ["Cable Crossover Machine"]),
    ...
    ("Lat Pulldown",
     ...
     "Back", None, False, ["Lat Pulldown Machine"]),
    ...
    ("Seated Cable Row",
     ...
     "Back", None, False, ["Cable Crossover Machine"]),
    ...
    ("Suspension Row",
     ...
     "Back", None, False, ["Suspension Trainer"]),
    ...
    ("Leg Press",
     ...
     "Legs", None, False, ["Leg Press Machine"]),
    ...
    ("Leg Curl",
     ...
     "Legs", None, False, ["Leg Curl Machine"]),
    ...
    ("Dumbbell Lateral Raise",
     ...
     "4. Avoid swinging.\n"
     "5. Keep core engaged.",
     "Shoulders", None, False, ["Dumbbells"]),
    ...
    ("Shoulder Press Machine",
     ...
     "Shoulders", None, False, ["Smith Machine"]),
    ...
    ("Tricep Pushdown",
     ...
     "Arms", None, False, ["Cable Crossover Machine"]),
    ...
    ("Cable Woodchopper",
     ...
     "Core", None, False, ["Cable Crossover Machine"]),
...
def add_initial_exercises(apps, schema_editor):
    ...
    for name, desc, instructions, primary, secondary, is_bodyweight, equipment_names in EXERCISES:
        slug = slugify(name)
